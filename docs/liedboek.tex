...
\hypersetup{
  pdftitle={Niderlandzki śpiewającoLiedboek},
...
\title{Niderlandzki śpiewającoLiedboek}
...
\includegraphics{liedboek_files/figure-latex/unnamed-chunk-4-1.pdf}
...
\hypertarget{leef-ux17cyj}{%
\section{Leef (Żyj)}\label{leef-ux17cyj}}

\hypertarget{tekst}{%
\subsection{Tekst}\label{tekst}}

Piosenka \citep{mozart:KV183} ,, fff
...
~
Nikt nie musi być dobry ani zły\\
Niemand is alleen maar zwart of wit\\
Iedereen is anders, anders dan je verwacht\\
\hspace*{0.333em}
Niemand die alleen maar haat of liefde voelt\\
